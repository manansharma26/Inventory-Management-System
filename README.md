...
Make sure you have Python installed (Python 3). sqlite3 comes built-in, so no extra installation needed.
Download or clone this repo. Make sure main.py and database.py are in the same folder.
...
Enter the number for whatever you want to do and follow the prompts.
